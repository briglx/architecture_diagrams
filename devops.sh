...
validate_deployment(){
    ...
    local location=$1
    local deployment_name="Architecture_Diagrams.Provisioning-${run_date}"
...
provision(){
    ...
    local location=$1
    local deployment_name="ArchitectureDiagrams.Provisioning-${run_date}"
...
deploy(){
    ...
    local deployment_name="Pythonarchitecture_diagrams.Deployment-${run_date}"
